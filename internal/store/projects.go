...
&p.Favorite, &p.IsOwner, &p.MemberCount, &p.CreatedAt, &p.UpdatedAt); err != nil {
...
&p.IsOwner, &p.MemberCount, &p.CreatedAt, &p.UpdatedAt); err != nil {
...
id, title, strings.TrimSpace(description), color, userID, now, now); err != nil {
